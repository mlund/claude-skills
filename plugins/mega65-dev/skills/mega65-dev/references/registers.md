...
annotations in the VHDL. Use it for lookup, then check the decode when an entry
is missing, ambiguous, or contradicted by observed behaviour.
...
For triggers, job formats, options, chaining and transfer measurements, read
[dma.md](dma.md).
